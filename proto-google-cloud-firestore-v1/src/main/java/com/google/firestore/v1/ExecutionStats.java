 ...
 * </pre>
 *
 * Protobuf type {@code google.firestore.v1.ExecutionStats}
 */
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.firestore.v1.QueryProfileProto.internal_static_google_firestore_v1_ExecutionStats_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.firestore.v1.QueryProfileProto.internal_static_google_firestore_v1_ExecutionStats_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.firestore.v1.ExecutionStats.class, com.google.firestore.v1.ExecutionStats.Builder.class);
  }
  ...
  public static final int BYTES_RETURNED_FIELD_NUMBER = 2;
  private long bytesReturned_ = 0L;
  /**
   * <pre>
   * Total number of the bytes of the results returned.
   * </pre>
   *
   * <code>int64 bytes_returned = 2;</code>
   * @return The bytesReturned.
   */
  @java.lang.Override
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (bytesReturned_ != 0L) {
      output.writeInt64(2, bytesReturned_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (bytesReturned_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(2, bytesReturned_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getBytesReturned()
        != other.getBytesReturned()) return false;
  ...
  public int hashCode() {
    ...
    hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
        getResultsReturned());
    hash = (37 * hash) + BYTES_RETURNED_FIELD_NUMBER;
    hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
        getBytesReturned());
    if (hasExecutionDuration()) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:google.firestore.v1.ExecutionStats)
    ...
    // Construct using com.google.firestore.v1.ExecutionStats.newBuilder()
    private Builder() {
    ...
    public com.google.firestore.v1.ExecutionStats getDefaultInstanceForType() {
      return com.google.firestore.v1.ExecutionStats.getDefaultInstance();
    }

    @java.lang.Override
    public com.google.firestore.v1.ExecutionStats build() {
      com.google.firestore.v1.ExecutionStats result = buildPartial();
    ...
    @java.lang.Override
    public com.google.firestore.v1.ExecutionStats buildPartial() {
      com.google.firestore.v1.ExecutionStats result = new com.google.firestore.v1.ExecutionStats(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(com.google.firestore.v1.ExecutionStats result) {
      int from_bitField0_ = bitField0_;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.resultsReturned_ = resultsReturned_;
      }
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.bytesReturned_ = bytesReturned_;
      }
      int to_bitField0_ = 0;
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.firestore.v1.ExecutionStats) {
        return mergeFrom((com.google.firestore.v1.ExecutionStats)other);
      } else {
    ...
    public Builder mergeFrom(com.google.firestore.v1.ExecutionStats other) {
      if (other == com.google.firestore.v1.ExecutionStats.getDefaultInstance()) return this;
      if (other.getResultsReturned() != 0L) {
        setResultsReturned(other.getResultsReturned());
      }
      if (other.getBytesReturned() != 0L) {
        setBytesReturned(other.getBytesReturned());
      }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              bytesReturned_ = input.readInt64();
     ...
     *
     * <code>int64 bytes_returned = 2;</code>
     * @param value The bytesReturned to set.
     * @return This builder for chaining.
     */
    public Builder setBytesReturned(long value) {

      bytesReturned_ = value;
      bitField0_ |= 0x00000002;
      onChanged();
      return this;
    }
  ...
  public static com.google.firestore.v1.ExecutionStats getDefaultInstance() {
