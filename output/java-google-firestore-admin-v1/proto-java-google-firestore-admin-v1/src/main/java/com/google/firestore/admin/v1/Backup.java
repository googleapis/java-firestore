...
public final class Backup extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(databaseUid_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, databaseUid_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(databaseUid_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(7, databaseUid_);
    }
    if (state_ != com.google.firestore.admin.v1.Backup.State.STATE_UNSPECIFIED.getNumber()) {
