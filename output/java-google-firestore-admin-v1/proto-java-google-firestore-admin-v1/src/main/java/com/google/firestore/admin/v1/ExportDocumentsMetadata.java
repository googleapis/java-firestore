...
public final class ExportDocumentsMetadata extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ExportDocumentsMetadata(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < collectionIds_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, collectionIds_.getRaw(i));
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(outputUriPrefix_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, outputUriPrefix_);
    }
    for (int i = 0; i < namespaceIds_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, namespaceIds_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(outputUriPrefix_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(7, outputUriPrefix_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < namespaceIds_.size(); i++) {
