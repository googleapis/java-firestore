...
public final class ImportDocumentsRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ImportDocumentsRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(inputUriPrefix_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, inputUriPrefix_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(inputUriPrefix_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, inputUriPrefix_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < namespaceIds_.size(); i++) {
