...
public class ExtendedTypesTest {
  ...
  public void BsonBinaryDataConvertsByteToIntAndIntToByteCorrectly() {
    ...
    Blob b4 = UserDataConverter.decodeBsonBinary(b1.toProto());
    Blob b5 = UserDataConverter.decodeBsonBinary(b2.toProto());
    Blob b6 = UserDataConverter.decodeBsonBinary(b3.toProto());
