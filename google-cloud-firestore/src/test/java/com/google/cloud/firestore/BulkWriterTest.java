...
public class BulkWriterTest {
  ...
  public static final ApiFuture<AbstractMessage> FAILED_FUTURE =
  ...
  private static final ApiFuture<AbstractMessage> RETRYABLE_FAILED_FUTURE =
      ApiFutures.immediateFailedFuture(
          new ApiException(
              new IllegalStateException("Mock batchWrite failed in test"),
  ...
  private static final ApiFuture<AbstractMessage> RESOURCE_EXHAUSTED_FAILED_FUTURE =
      ApiFutures.immediateFailedFuture(
          new ApiException(
              new IllegalStateException("Mock batchWrite failed in test"),
