...
public interface NamedQueryOrBuilder extends
    // @@protoc_insertion_point(interface_extends:firestore.NamedQuery)
   ...
   */
  com.google.firestore.proto.BundledQuery getBundledQuery();
  /**
   * <pre>
   * The query saved in the bundle.
   * </pre>
   ...
   * <code>.firestore.BundledQuery bundled_query = 2;</code>
   */
  com.google.firestore.proto.BundledQueryOrBuilder getBundledQueryOrBuilder();
