...
public abstract class Expression {
  ...
  private static Expression toExprOrConstant(Object o) {
    return o instanceof Expression ? (Expression) o : Constant.of(o);
  }
  ...
  public static BooleanExpression constant(Boolean value) {
    return equal(Constant.of(value), true);
  }
   ...
   * @return A new {@link Expression} constant instance representing the Blob.
   */
  @BetaApi
  public static Expression blob(byte[] bytes) {
  ...
  public static BooleanExpression equal(Expression left, Expression right) {
    return new BooleanExpression("eq", left, right);
  }
  ...
  public static BooleanExpression equal(Expression left, Object right) {
    return new BooleanExpression("eq", left, toExprOrConstant(right));
  }
  ...
  public static BooleanExpression notEqual(Expression left, Expression right) {
    return new BooleanExpression("neq", left, right);
  }
  ...
  public static BooleanExpression notEqual(Expression left, Object right) {
    return new BooleanExpression("neq", left, toExprOrConstant(right));
  }
  ...
  public static BooleanExpression greaterThan(Expression left, Expression right) {
    return new BooleanExpression("gt", left, right);
  }
  ...
  public static BooleanExpression greaterThan(Expression left, Object right) {
    return new BooleanExpression("gt", left, toExprOrConstant(right));
  }
  ...
  public static BooleanExpression greaterThanOrEqual(Expression left, Expression right) {
    return new BooleanExpression("gte", left, right);
  }
  ...
  public static BooleanExpression greaterThanOrEqual(Expression left, Object right) {
    return new BooleanExpression("gte", left, toExprOrConstant(right));
  }
  ...
  public static BooleanExpression lessThan(Expression left, Expression right) {
    return new BooleanExpression("lt", left, right);
  }
  ...
  public static BooleanExpression lessThan(Expression left, Object right) {
    return new BooleanExpression("lt", left, toExprOrConstant(right));
  }
  ...
  public static BooleanExpression lessThanOrEqual(Expression left, Expression right) {
    return new BooleanExpression("lte", left, right);
  }
  ...
  public static BooleanExpression lessThanOrEqual(Expression left, Object right) {
    return new BooleanExpression("lte", left, toExprOrConstant(right));
  }
  ...
  public static BooleanExpression equalAny(Expression expression, Expression arrayExpression) {
    return new BooleanExpression("eq_any", expression, arrayExpression);
  }
  ...
  public static BooleanExpression notEqualAny(Expression expression, Expression arrayExpression) {
    return new BooleanExpression("not_eq_any", expression, arrayExpression);
  }
   ...
   * @return A new {@link Expression} representing the reversed string.
   */
  @BetaApi
  public static Expression strReverse(Expression string) {
    return new FunctionExpression("str_reverse", ImmutableList.of(string));
  }
   ...
   */
  @BetaApi
  public static Expression strReverse(String fieldName) {
   ...
   */
  @BetaApi
  public static BooleanExpression strContains(Expression string, Expression substring) {
    return new BooleanExpression("str_contains", string, substring);
  }
   ...
   */
  @BetaApi
  public static BooleanExpression strContains(Expression string, String substring) {
   ...
   */
  @BetaApi
  public static BooleanExpression strContains(String fieldName, Expression substring) {
   ...
   */
  @BetaApi
  public static BooleanExpression strContains(String fieldName, String substring) {
   ...
   */
  @BetaApi
  public static Expression substr(Expression string, Expression index, Expression length) {
    return new FunctionExpression("substr", ImmutableList.of(string, index, length));
  }
   ...
   */
  @BetaApi
  public static Expression substr(String fieldName, int index, int length) {
   ...
   */
  @BetaApi
  public static Expression strConcat(Expression firstString, Object... otherStrings) {
    ImmutableList.Builder<Expression> builder = ImmutableList.builder();
    builder.add(firstString);
    builder.addAll(toArrayOfExprOrConstant(otherStrings));
    return new FunctionExpression("str_concat", builder.build());
  }
   ...
   */
  @BetaApi
  public static Expression strConcat(String fieldName, Object... otherStrings) {
   ...
   */
  @BetaApi
  public static Expression timestampSub(Expression timestamp, Expression unit, Expression amount) {
    return new FunctionExpression("timestamp_sub", ImmutableList.of(timestamp, unit, amount));
  }
   ...
   */
  @BetaApi
  public static Expression timestampSub(Expression timestamp, String unit, long amount) {
   ...
   */
  @BetaApi
  public static Expression timestampSub(String fieldName, Expression unit, Expression amount) {
   ...
   */
  @BetaApi
  public static Expression timestampSub(String fieldName, String unit, long amount) {
   ...
   */
  @BetaApi
  public static Expression cond(
      BooleanExpression condition, Expression thenExpr, Expression elseExpr) {
    return new FunctionExpression("cond", ImmutableList.of(condition, thenExpr, elseExpr));
  }
   ...
   */
  @BetaApi
  public static Expression cond(BooleanExpression condition, Object thenValue, Object elseValue) {
  ...
  public static Expression logicalMaximum(Expression expr, Object... others) {
    ...
    return new FunctionExpression("max", builder.build());
  }
  ...
  public static Expression logicalMinimum(Expression expr, Object... others) {
    ...
    builder.add(expr);
    builder.addAll(toArrayOfExprOrConstant(others));
    return new FunctionExpression("min", builder.build());
  }
   ...
   *
   * @param base The base of the logarithm.
   * @return A new {@link Expression} representing a numeric result from the logarithm of this
   *     numeric expression with a given {@code base}.
   */
  @BetaApi
  public final Expression log(Number base) {
   ...
   */
  @BetaApi
  public final Expression log(Expression base) {
    return log(this, base);
  }
   ...
   */
  @BetaApi
  public final Expression strReverse() {
   ...
   */
  @BetaApi
  public final BooleanExpression strContains(Object substring) {
   ...
   */
  @BetaApi
  public final Expression substr(Object index, Object length) {
   ...
   */
  @BetaApi
  public final Expression strConcat(String... others) {
   ...
   */
  @BetaApi
  public final Expression strConcat(Expression... others) {
    return strConcat(this, others);
  }
   ...
   */
  @BetaApi
  public final Expression timestampSub(Expression unit, Expression amount) {
   ...
   */
  @BetaApi
  public final Expression timestampSub(String unit, long amount) {
    return timestampSub(this, unit, amount);
  }
   ...
   */
  @BetaApi
  public final Expression cond(Expression thenExpr, Expression elseExpr) {
    return cond((BooleanExpression) this, thenExpr, elseExpr);
  }
   ...
   */
  @BetaApi
  public final Expression cond(Object thenValue, Object elseValue) {
    return cond((BooleanExpression) this, thenValue, elseValue);
  }
