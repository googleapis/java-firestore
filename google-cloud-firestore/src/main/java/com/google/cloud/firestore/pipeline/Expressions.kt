...
internal data class ListOfConditions(val conditions: List<Expr.Function.FilterCondition>): Expr, Expr.Function.FilterCondition {}
...
sealed interface Expr {
  ...
  data class AccumulatorTarget(val current: Function.Accumulator, val target: String): Expr, Function.Accumulator {}

  sealed class Function(val name: String, val params: Map<String, Expr>?) : Expr {
    interface FilterCondition {
      infix fun and(other: FilterCondition)= Function.And(listOf(this, other))
      fun and(vararg other: FilterCondition)= Function.And(listOf(this) + other.toList())
    ...
    interface Accumulator {
      fun toField(target: String) = AccumulatorTarget(this, target)
    }

    data class Equal internal constructor(val left: Expr, val right: Expr) : Function("equal", mapOf("left" to left, "right" to right)), FilterCondition
    data class NotEqual(val left: Expr, val right: Expr) : Function("not_equal", mapOf("left" to left, "right" to right)), FilterCondition
    data class GreaterThan(val left: Expr, val right: Expr) : Function("greater_than", mapOf("left" to left, "right" to right)), FilterCondition
    data class GreaterThanOrEqual(val left: Expr, val right: Expr) : Function("greater_than_equal", mapOf("left" to left, "right" to right)), FilterCondition
    data class In(val left: Expr, val others: List<Expr>) : Function("in", mapOf("left" to left, "others" to ListOfExprs(others))), FilterCondition // For 'in'
    data class LessThan(val left: Expr, val right: Expr) : Function("less_than", mapOf("left" to left, "right" to right)), FilterCondition
    data class LessThanOrEqual(val left: Expr, val right: Expr) : Function("less_than_equal", mapOf("left" to left, "right" to right)), FilterCondition
    data class NotIn(val left: Expr, val others: List<Expr>) : Function("not_in", mapOf("left" to left, "others" to ListOfExprs(others))), FilterCondition // For 'not in'
    data class And(val conditions: List<FilterCondition>) : Function("and", mapOf("conditions" to ListOfConditions(conditions))), FilterCondition
    data class Or(val conditions: List<FilterCondition>) : Function("or", mapOf("conditions" to ListOfConditions(conditions))), FilterCondition
    data class Not(val condition: Expr) : Function("not", mapOf("condition" to condition)), FilterCondition
    data class Exists(val current: Field) : Function("exists", mapOf("current" to current)), FilterCondition
    ...
    data class ArrayContains(val array: Expr, val element: Expr) : Function("array_contains", mapOf("array" to array, "element" to element)), FilterCondition
    data class ArrayContainsAny(val array: Expr, val elements: List<Expr>) : Function("array_contains_any", mapOf("array" to array, "elements" to ListOfExprs(elements))), FilterCondition
    data class IsNaN(val value: Expr) : Function("is_nan", mapOf("value" to value)), FilterCondition
    data class IsNull(val value: Expr) : Function("is_null", mapOf("value" to value)), FilterCondition
    ...
    data class HasAncestor(val child: Expr, val ancestor: Expr): Function("has_ancestor", mapOf("child" to child, "ancestor" to ancestor)), FilterCondition
  ...
  infix fun euclideanDistance(other: DoubleArray)= Function.EuclideanDistance(this, Constant.of(other))
  ...
  companion object {
    ...
    @JvmStatic
    fun and(left: Function.FilterCondition, right: Function.FilterCondition)= Function.And(listOf(left, right))

    @JvmStatic
    fun and(left: Function.FilterCondition, vararg other: Function.FilterCondition)= Function.And(listOf(left) + other.toList())

    @JvmStatic
    fun or(left: Function.FilterCondition, right: Function.FilterCondition)= Function.Or(listOf(left, right))

    @JvmStatic
    fun or(left: Function.FilterCondition, vararg other: Function.FilterCondition)= Function.Or(listOf(left) + other.toList())
    ...
    @JvmStatic
    fun arrayContainsAny(expr: Expr, vararg elements: Expr)= Function.ArrayContainsAny(expr, elements.toList())
    ...
    @JvmStatic
    fun cosineDistance(expr: Expr, other: DoubleArray)= Function.CosineDistance(expr, Constant.of(other))

    @JvmStatic
    fun euclideanDistance(expr: Expr, other: Expr)= Function.EuclideanDistance(expr, other)

    @JvmStatic
    fun euclideanDistance(expr: Expr, other: DoubleArray)= Function.EuclideanDistance(expr, Constant.of(other))
    ...
    @JvmStatic
    fun function(name: String, params: Map<String, Expr>?)= Function.Raw(name, params)
  }
