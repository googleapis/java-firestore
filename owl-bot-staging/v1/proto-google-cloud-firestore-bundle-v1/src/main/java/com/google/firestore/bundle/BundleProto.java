...
public final class BundleProto {
  ...
  static {
    ...
    internal_static_google_firestore_bundle_BundledQuery_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_firestore_bundle_BundledQuery_descriptor,
        new java.lang.String[] { "Parent", "StructuredQuery", "LimitType", "QueryType", });
    internal_static_google_firestore_bundle_NamedQuery_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_firestore_bundle_NamedQuery_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_firestore_bundle_NamedQuery_descriptor,
        new java.lang.String[] { "Name", "BundledQuery", "ReadTime", });
    internal_static_google_firestore_bundle_BundledDocumentMetadata_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_firestore_bundle_BundledDocumentMetadata_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_firestore_bundle_BundledDocumentMetadata_descriptor,
        new java.lang.String[] { "Name", "ReadTime", "Exists", "Queries", });
    internal_static_google_firestore_bundle_BundleMetadata_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_firestore_bundle_BundleMetadata_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_firestore_bundle_BundleMetadata_descriptor,
        new java.lang.String[] { "Id", "CreateTime", "Version", "TotalDocuments", "TotalBytes", });
    internal_static_google_firestore_bundle_BundleElement_descriptor =
      getDescriptor().getMessageTypes().get(4);
    internal_static_google_firestore_bundle_BundleElement_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_firestore_bundle_BundleElement_descriptor,
