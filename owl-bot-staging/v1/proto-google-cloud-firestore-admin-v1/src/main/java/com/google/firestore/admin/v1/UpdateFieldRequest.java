...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            field_ = input.readMessage(com.google.firestore.admin.v1.Field.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeField(com.google.firestore.admin.v1.Field value) {
      if (fieldBuilder_ == null) {
        if (field_ != null) {
          field_ =
            com.google.firestore.admin.v1.Field.newBuilder(field_).mergeFrom(value).buildPartial();
        } else {
          field_ = value;
        }
        onChanged();
    ...
    public com.google.firestore.admin.v1.FieldOrBuilder getFieldOrBuilder() {
      if (fieldBuilder_ != null) {
        ...
        return field_ == null ?
            com.google.firestore.admin.v1.Field.getDefaultInstance() : field_;
      }
    }
    /**
     * <pre>
  ...
  private static final com.google.protobuf.Parser<UpdateFieldRequest>
      PARSER = new com.google.protobuf.AbstractParser<UpdateFieldRequest>() {
    @java.lang.Override
