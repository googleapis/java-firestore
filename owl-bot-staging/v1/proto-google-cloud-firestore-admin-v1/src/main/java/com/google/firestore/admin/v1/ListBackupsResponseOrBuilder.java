...
public interface ListBackupsResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.firestore.admin.v1.Backup> 
      getBackupsList();
  /**
   * <pre>
   * List of all backups for the project.
   ...
   * <code>repeated .google.firestore.admin.v1.Backup backups = 1;</code>
   */
  java.util.List<? extends com.google.firestore.admin.v1.BackupOrBuilder> 
   ...
   * <code>repeated .google.firestore.admin.v1.Backup backups = 1;</code>
   */
  com.google.firestore.admin.v1.BackupOrBuilder getBackupsOrBuilder(
      int index);
