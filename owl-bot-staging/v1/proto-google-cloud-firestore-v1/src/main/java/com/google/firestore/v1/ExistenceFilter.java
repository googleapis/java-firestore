  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.firestore.v1.ExistenceFilter result) {
      ...
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.unchangedNames_ = unchangedNamesBuilder_ == null
            ? unchangedNames_
            : unchangedNamesBuilder_.build();
      }
    }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  getUnchangedNamesFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.firestore.v1.BloomFilter, com.google.firestore.v1.BloomFilter.Builder, com.google.firestore.v1.BloomFilterOrBuilder> unchangedNamesBuilder_;
    /**
     * <pre>
     * A bloom filter that contains the UTF-8 byte encodings of the resource names
     * of the documents that match
