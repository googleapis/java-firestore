      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            targetType_ =
                input.readMessage(com.google.firestore.v1.Target.QueryTarget.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 26: {
            ...
            if (targetTypeCase_ == 3) {
              subBuilder = ((com.google.firestore.v1.Target.DocumentsTarget) targetType_).toBuilder();
            }
            targetType_ =
                input.readMessage(com.google.firestore.v1.Target.DocumentsTarget.parser(), extensionRegistry);
            if (subBuilder != null) {
