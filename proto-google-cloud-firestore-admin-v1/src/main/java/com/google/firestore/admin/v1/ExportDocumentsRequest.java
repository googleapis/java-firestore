...
public final class ExportDocumentsRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ExportDocumentsRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(outputUriPrefix_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, outputUriPrefix_);
    }
    for (int i = 0; i < namespaceIds_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, namespaceIds_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(outputUriPrefix_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, outputUriPrefix_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < namespaceIds_.size(); i++) {
